...
//                }
    ...
    public function edit($id, Request $request)
    {
        ...
        $tenant->property_address = isset($propertyaddress->address) ? $propertyaddress->address : "";
        $tenant->property_city = isset($propertyaddress->city) ? $propertyaddress->city : "";
        $tenant->property_state = isset($propertyaddress->state) ? $propertyaddress->state : "";
        $tenant->property_zip = isset($propertyaddress->zip) ? $propertyaddress->zip : "";
...
// add more fields (all fields that users table contains without id)
            ...
            $flag = "0";
            if(!empty($tenant->propertyaddress->first()->id)){
