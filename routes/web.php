...
Route::group(['prefix' => 'admin','namespace'=>'Admin','middleware'=>'auth'], function () {
   ...
   //  Route::get('/users/updatestatus/{id}', ['as' => 'update.status', 'uses' => 'UserController@updatestatus']);
    ...
    Route::get('property/partial_tenant/{id}',['as' => 'property.partial_tenant', 'uses' => 'PropertyController@partial_tenant']);
     ...
     Route::delete('/inspector_schedule/{id}',['as' => 'inspection_delete', 'uses' => 'InspectorScheduleController@destroy']);

     Route::post('/inspector_schedule/cancel/{id}',['as' => 'inspection_cancel', 'uses' => 'InspectorScheduleController@cancel']);

     Route::post('/inspector_schedule/get_comment/{id}',['as' => 'get_comment', 'uses' => 'InspectorScheduleController@comment']);

      Route::post('/inspector_schedule/save_comment/{id}',['as' => 'save_comment', 'uses' => 'InspectorScheduleController@saveComment']);

     //inspectFailLetterPartialinspector.failed_letter_bridgeport
     ...
     Route::get('inspector/failed/letter/bridgeport/{id}',['as' => 'inspector.failed_letter_bridgeport', 'uses' => 'InspectorScheduleController@inspectFailLetterBridgedPartial']);
...
Route::get('/inspection/form/{id}',['as'=>'inspection.show', 'uses'=>'Inspector\InspectorFormController@show']);
 Route::post('/inspection/form',['as'=>'inspection.form', 'uses'=>'Inspector\InspectorFormController@store']);
    Route::post('/inspection/form/uploadFiles',['as'=>'inspection.fileUpload', 'uses'=>'Inspector\InspectorFormController@fileUpload']);
    Route::post('/inspection/form/downloadFiles',['as'=>'inspection.fileDownload', 'uses'=>'Inspector\InspectorFormController@fileDownload']);
    Route::post('/inspection/form/alldownload',['as'=>'inspection.alldownload', 'uses'=>'Inspector\InspectorFormController@allFileDownload']);
