      ...
      <tr>
        <td>
          ...
          <!--                    Checking failure condition for Livining Room              -->
               ...
               $ins['1_9a_lead_based_paint']=="fail"||$ins['1_9b_lead_based_paint']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['1_1_living_room_present']=="fail" && $ins['1_1_failure_choice']==2)
                              01.01 Living Room Present:
                              {{$ins['1_1_Comment']}}<br>
                          @endif
                          @if($ins['1_2_electricity']=="fail" && $ins['1_2_failure_choice']==2)
                              01.02 Electricity:
                              {{$ins['1_2_Comment']}}<br>
                          @endif
                          @if($ins['1_3_electricity_hazards']=="fail" && $ins['1_3_failure_choice']==2)
                              01.03 Electricity Hazards:
                              {{$ins['1_3_Comment']}}<br>
                          @endif
                          @if($ins['1_4_security']=="fail" && $ins['1_4_failure_choice']==2)
                              01.04 Security:
                              {{$ins['1_4_Comment']}}<br>
                          @endif
                          @if($ins['1_5_window_condition']=="fail" && $ins['1_5_failure_choice']==2)
                              01.05 Window Condition:
                              {{$ins['1_5_Comment']}}<br>
                          @endif
                          @if($ins['1_6_celling_condition']=="fail" && $ins['1_6_failure_choice']==2)
                              01.06 Celling Condition:
                              {{$ins['1_6_Comment']}}<br>
                          @endif
                          @if($ins['1_7_wall_condition']=="fail" && $ins['1_7_failure_choice']==2)
                              01.07 Wall Condition:
                              {{$ins['1_7_Comment']}}<br>
                          @endif
                          @if($ins['1_8_floorcondition']=="fail" && $ins['1_8_failure_choice']==2)
                              01.08 Floor Condition:
                              {{$ins['1_8_Comment']}}<br>
                          @endif
                          @if($ins['1_9a_lead_based_paint']=="fail" && $ins['1_9a_failure_choice']==2)
                              01.09.01 Lead Based Paint:
                              {{$ins['1_9a_Comment']}}<br>
                          @endif
                          @if($ins['1_9b_lead_based_paint']=="fail" && $ins['1_9b_failure_choice']==2)
                 ...
                 $ins['2_12px_sink']=="fail"||$ins['2_13_space_for_storage_preparation_and_serving_of_food']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['2_1_kitchen_present']=="fail" && $ins['2_1_failure_choice']==2)
                              02.01 Living Room Present:
                              {{$ins['2_1_Comment']}}<br>
                          @endif
                          @if($ins['2_2_electricity']=="fail" && $ins['2_2_failure_choice']==2)
                              02.02 Electricity:
                              {{$ins['2_2_Comment']}}<br>
                          @endif
                          @if($ins['2_3_electricity_hazards']=="fail" && $ins['2_3_failure_choice']==2)
                              02.03 Electricity Hazards:
                              {{$ins['2_3_Comment']}}<br>
                          @endif
                          @if($ins['2_4_security']=="fail" && $ins['2_4_failure_choice']==2)
                              02.04 Security:
                              {{$ins['2_4_Comment']}}<br>
                          @endif
                          @if($ins['2_5_window_condition']=="fail" && $ins['2_5_failure_choice']==2)
                              02.05 Window Condition:
                              {{$ins['2_5_Comment']}}<br>
                          @endif
                          @if($ins['2_6_celling_condition']=="fail" && $ins['2_6_failure_choice']==2)
                              02.06 Celling Condition:
                              {{$ins['2_6_Comment']}}<br>
                          @endif
                          @if($ins['2_7_wall_condition']=="fail" && $ins['2_7_failure_choice']==2)
                              02.07 Wall Condition:
                              {{$ins['2_7_Comment']}}<br>
                          @endif
                          @if($ins['2_8_floorcondition']=="fail" && $ins['2_8_failure_choice']==2)
                              02.08 Floor Condition:
                              {{$ins['2_8_Comment']}}<br>
                          @endif
                          @if($ins['2_9a_lead_based_paint']=="fail" && $ins['2_9a_failure_choice']==2)
                              02.09.01 Lead Based Paint:
                              {{$ins['2_9a_Comment']}}<br>
                          @endif
                          @if($ins['2_9b_lead_based_paint']=="fail" && $ins['2_9b_failure_choice']==2)
                              02.09.02 Lead Based Paint:
                              {{$ins['2_9b_Comment']}}<br>
                          @endif
                          @if($ins['2_10_stove_of_range_with_oven']=="fail" && $ins['2_10_failure_choice']==2)
                              02.10 Stove or Range with Oven:
                              {{$ins['2_10_Comment']}}<br>
                          @endif
                          @if($ins['2_11_refrigerator']=="fail" && $ins['2_11_failure_choice']==2)
                              02.11 Refrigerator:
                              {{$ins['2_11_Comment']}}<br>
                          @endif
                          @if($ins['2_12px_sink']=="fail" && $ins['2_12_failure_choice']==2)
                              02.12px Sink:
                              {{$ins['2_12px_Comment']}}<br>
                          @endif
                          @if($ins['2_13_space_for_storage_preparation_and_serving_of_food']=="fail" && $ins['2_13_failure_choice']==2)
                 ...
                 $ins['3_12px_tub_or_shower_in_unit']=="fail"||$ins['3_13_ventilation']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['3_1_bathroom_present']=="fail" && $ins['3_1_failure_choice']==2)
                              03.01 Bathroom Present:
                              {{$ins['3_1_Comment']}}<br>
                          @endif
                          @if($ins['3_2_electricity']=="fail" && $ins['3_2_failure_choice']==2)
                              03.02 Electricity:
                              {{$ins['3_2_Comment']}}<br>
                          @endif
                          @if($ins['3_3_electricity_hazards']=="fail" && $ins['3_3_failure_choice']==2)
                              03.03 Electricity Hazards:
                              {{$ins['3_3_Comment']}}<br>
                          @endif
                          @if($ins['3_4_security']=="fail" && $ins['3_4_failure_choice']==2)
                              03.04 Security:
                              {{$ins['3_4_Comment']}}<br>
                          @endif
                          @if($ins['3_5_window_condition']=="fail" && $ins['3_5_failure_choice']==2)
                              03.05 Window Condition:
                              {{$ins['3_5_Comment']}}<br>
                          @endif
                          @if($ins['3_6_celling_condition']=="fail" && $ins['3_6_failure_choice']==2)
                              03.06 Celling Condition:
                              {{$ins['3_6_Comment']}}<br>
                          @endif
                          @if($ins['3_7_wall_condition']=="fail" && $ins['3_7_failure_choice']==2)
                              03.07 Wall Condition:
                              {{$ins['3_7_Comment']}}<br>
                          @endif
                          @if($ins['3_8_floorcondition']=="fail" && $ins['3_8_failure_choice']==2)
                              03.08 Floor Condition:
                              {{$ins['3_8_Comment']}}<br>
                          @endif
                          @if($ins['3_9a_lead_based_paint']=="fail" && $ins['3_9a_failure_choice']==2)
                              03.09.01 Lead Based Paint:
                              {{$ins['3_9a_Comment']}}<br>
                          @endif
                          @if($ins['3_9b_lead_based_paint']=="fail" && $ins['3_9b_failure_choice']==2)
                              03.09.02 Lead Based Paint:
                              {{$ins['3_9b_Comment']}}<br>
                          @endif
                          @if($ins['3_10_flush_toilet_in_enclosed_room_in_unit']=="fail" && $ins['3_10_failure_choice']==2)
                              03.10 Flush Toilet in enclosed room in unit:
                              {{$ins['3_10_Comment']}}<br>
                          @endif
                          @if($ins['3_11_fixed_wash_basin_or_lavatory_in_unit']=="fail" && $ins['3_11_failure_choice']==2)
                              03.11 Fixed Wash Basin or Lavatory in unit:
                              {{$ins['3_11_Comment']}}<br>
                          @endif
                          @if($ins['3_12px_tub_or_shower_in_unit']=="fail" && $ins['3_12_failure_choice']==2)
                              03.12px Tub or Shower in Unit :
                              {{$ins['3_12px_Comment']}}<br>
                          @endif
                          @if($ins['3_13_ventilation']=="fail" && $ins['3_13_failure_choice']==2)
                              03.13 Ventillation:
                              {{$ins['3_13_Comment']}}<br>
                          @endif
                      </td>
                 ...
                 $ins['4a_10_smoke_detectors']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @endif
                          @if($ins['4a_2_electricity_or_illumination']=="fail" && $ins['4a_2_failure_choice']==2)
                              04.02 Electricity:
                              {{$ins['4a_2_Comment']}}<br>
                          @endif
                          @if($ins['4a_3_electricity_hazards']=="fail" && $ins['4a_3_failure_choice']==2)
                              04.03 Electricity Hazards:
                              {{$ins['4a_3_Comment']}}<br>
                          @endif
                          @if($ins['4a_4_security']=="fail" && $ins['4a_4_failure_choice']==2)
                              04.04 Security:
                              {{$ins['4a_4_Comment']}}<br>
                          @endif
                          @if($ins['4a_5_window_condition']=="fail" && $ins['4a_5_failure_choice']==2)
                              04.05 Window Condition:
                              {{$ins['4a_5_Comment']}}<br>
                          @endif
                          @if($ins['4a_6_celling_condition']=="fail" && $ins['4a_6_failure_choice']==2)
                              04.06 Celling Condition:
                              {{$ins['4a_6_Comment']}}<br>
                          @endif
                          @if($ins['4a_7_wall_condition']=="fail" && $ins['4a_7_failure_choice']==2)
                              04.07 Wall Condition:
                              {{$ins['4a_7_Comment']}}<br>
                          @endif
                          @if($ins['4a_8_floorcondition']=="fail" && $ins['4a_8_failure_choice']==2)
                              04.08 Floor Condition:
                              {{$ins['4a_8_Comment']}}<br>
                          @endif
                          @if($ins['4a_9a_lead_based_paint']=="fail" && $ins['4a_9a_failure_choice']==2)
                              04.09.01 Lead Based Paint:
                              {{$ins['4a_9a_Comment']}}<br>
                          @endif
                          @if($ins['4a_9b_lead_based_paint']=="fail" && $ins['4a_9b_failure_choice']==2)
                              04.09.02 Lead Based Paint:
                              {{$ins['4a_9b_Comment']}}<br>
                          @endif
                          @if($ins['4a_10_smoke_detectors']=="fail" && $ins['4a_10_failure_choice']==2)
                 ...
                 $ins['4b_10_smoke_detectors']=="fail")
                  <tr>
                      <td class="4b1a" style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @endif
                          @if($ins['4b_2_electricity_or_illumination']=="fail" && $ins['4b_2_failure_choice']==2)
                              04.02 Electricity:
                              {{$ins['4b_2_Comment']}}<br>
                          @endif
                          @if($ins['4b_3_electricity_hazards']=="fail" && $ins['4b_3_failure_choice']==2)
                              04.03 Electricity Hazards:
                              {{$ins['4b_3_Comment']}}<br>
                          @endif
                          @if($ins['4b_4_security']=="fail" && $ins['4b_4_failure_choice']==2)
                              04.04 Security:
                              {{$ins['4b_4_Comment']}}<br>
                          @endif
                          @if($ins['4b_5_window_condition']=="fail" && $ins['4b_5_failure_choice']==2)
                              04.05 Window Condition:
                              {{$ins['4b_5_Comment']}}<br>
                          @endif
                          @if($ins['4b_6_celling_condition']=="fail" && $ins['4b_6_failure_choice']==2)
                              04.06 Celling Condition:
                              {{$ins['4b_6_Comment']}}<br>
                          @endif
                          @if($ins['4b_7_wall_condition']=="fail" && $ins['4b_7_failure_choice']==2)
                              04.07 Wall Condition:
                              {{$ins['4b_7_Comment']}}<br>
                          @endif
                          @if($ins['4b_8_floorcondition']=="fail" && $ins['4b_8_failure_choice']==2)
                              04.08 Floor Condition:
                              {{$ins['4b_8_Comment']}}<br>
                          @endif
                          @if($ins['4b_9a_lead_based_paint']=="fail" && $ins['4b_9a_failure_choice']==2)
                              04.09.01 Lead Based Paint:
                              {{$ins['4b_9a_Comment']}}<br>
                          @endif
                          @if($ins['4b_9b_lead_based_paint']=="fail" && $ins['4b_9b_failure_choice']==2)
                              04.09.02 Lead Based Paint:
                              {{$ins['4b_9b_Comment']}}<br>
                          @endif
                          @if($ins['4b_10_smoke_detectors']=="fail" && $ins['4b_10_failure_choice']==2)
                              04.10 Stove or Range with Oven:
                 ...
                 $ins['4c_10_smoke_detectors']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['4c_2_electricity_or_illumination']=="fail" && $ins['4c_2_failure_choice']==2)
                              04.02 Electricity:
                              {{$ins['4c_2_Comment']}}<br>
                          @endif
                          @if($ins['4c_3_electricity_hazards']=="fail" && $ins['4c_3_failure_choice']==2)
                              04.03 Electricity Hazards:
                              {{$ins['4c_3_Comment']}}<br>
                          @endif
                          @if($ins['4c_4_security']=="fail" && $ins['4c_4_failure_choice']==2)
                              04.04 Security:
                              {{$ins['4c_4_Comment']}}<br>
                          @endif
                          @if($ins['4c_5_window_condition']=="fail" && $ins['4c_5_failure_choice']==2)
                              04.05 Window Condition:
                              {{$ins['4c_5_Comment']}}<br>
                          @endif
                          @if($ins['4c_6_celling_condition']=="fail" && $ins['4c_6_failure_choice']==2)
                              04.06 Celling Condition:
                              {{$ins['4c_6_Comment']}}<br>
                          @endif
                          @if($ins['4c_7_wall_condition']=="fail" && $ins['4c_7_failure_choice']==2)
                              04.07 Wall Condition:
                              {{$ins['4c_7_Comment']}}<br>
                          @endif
                          @if($ins['4c_8_floorcondition']=="fail" && $ins['4c_8_failure_choice']==2)
                              04.08 Floor Condition:
                              {{$ins['4c_8_Comment']}}<br>
                          @endif
                          @if($ins['4c_9a_lead_based_paint']=="fail" && $ins['4c_9a_failure_choice']==2)
                              04.09.01 Lead Based Paint:
                              {{$ins['4c_9a_Comment']}}<br>
                          @endif
                          @if($ins['4c_9b_lead_based_paint']=="fail" && $ins['4c_9b_failure_choice']==2)
                              04.09.02 Lead Based Paint:
                              {{$ins['4c_9b_Comment']}}<br>
                          @endif
                          @if($ins['4c_10_smoke_detectors']=="fail" && $ins['4c_10_failure_choice']==2)
                              04.10 Stove or Range with Oven:
                 ...
                 $ins['4d_10_smoke_detectors']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['4d_2_electricity_or_illumination']=="fail" && $ins['4d_2_failure_choice']==2)
                              04.02 Electricity:
                              {{$ins['4d_2_Comment']}}<br>
                          @endif
                          @if($ins['4d_3_electricity_hazards']=="fail" && $ins['4d_3_failure_choice']==2)
                              04.03 Electricity Hazards:
                              {{$ins['4d_3_Comment']}}<br>
                          @endif
                          @if($ins['4d_4_security']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.04 Security:
                              {{$ins['4d_4_Comment']}}<br>
                          @endif
                          @if($ins['4d_5_window_condition']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.05 Window Condition:
                              {{$ins['4d_5_Comment']}}<br>
                          @endif
                          @if($ins['4d_6_celling_condition']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.06 Celling Condition:
                              {{$ins['4d_6_Comment']}}<br>
                          @endif
                          @if($ins['4d_7_wall_condition']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.07 Wall Condition:
                              {{$ins['4d_7_Comment']}}<br>
                          @endif
                          @if($ins['4d_8_floorcondition']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.08 Floor Condition:
                              {{$ins['4d_8_Comment']}}<br>
                          @endif
                          @if($ins['4d_9a_lead_based_paint']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.09.01 Lead Based Paint:
                              {{$ins['4d_9a_Comment']}}<br>
                          @endif
                          @if($ins['4d_9b_lead_based_paint']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.09.02 Lead Based Paint:
                              {{$ins['4d_9b_Comment']}}<br>
                          @endif
                          @if($ins['4d_10_smoke_detectors']=="fail"  && $ins['4d_2_failure_choice']==2)
                              04.10 Stove or Range with Oven:
                ...
                $ins['4e_10_smoke_detectors']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['4e_2_electricity_or_illumination']=="fail"  && $ins['4e_2_failure_choice']==2)
                              04.02 Electricity:
                              {{$ins['4e_2_Comment']}}<br>
                          @endif
                          @if($ins['4e_3_electricity_hazards']=="fail"  && $ins['4e_3_failure_choice']==2)
                              04.03 Electricity Hazards:
                              {{$ins['4e_3_Comment']}}<br>
                          @endif
                          @if($ins['4e_4_security']=="fail"  && $ins['4e_4_failure_choice']==2)
                              04.04 Security:
                              {{$ins['4e_4_Comment']}}<br>
                          @endif
                          @if($ins['4e_5_window_condition']=="fail"  && $ins['4e_5_failure_choice']==2)
                              04.05 Window Condition:
                              {{$ins['4e_5_Comment']}}<br>
                          @endif
                          @if($ins['4e_6_celling_condition']=="fail"  && $ins['4e_6_failure_choice']==2)
                              04.06 Celling Condition:
                              {{$ins['4e_6_Comment']}}<br>
                          @endif
                          @if($ins['4e_7_wall_condition']=="fail"  && $ins['4e_7_failure_choice']==2)
                              04.07 Wall Condition:
                              {{$ins['4e_7_Comment']}}<br>
                          @endif
                          @if($ins['4e_8_floorcondition']=="fail"  && $ins['4e_8_failure_choice']==2)
                              04.08 Floor Condition:
                              {{$ins['4e_8_Comment']}}<br>
                          @endif
                          @if($ins['4e_9a_lead_based_paint']=="fail" && $ins['4e_9a_failure_choice']==2)
                              04.09.01 Lead Based Paint:
                              {{$ins['4e_9a_Comment']}}<br>
                          @endif
                          @if($ins['4e_9b_lead_based_paint']=="fail" && $ins['4e_9b_failure_choice']==2)
                              04.09.02 Lead Based Paint:
                              {{$ins['4e_9b_Comment']}}<br>
                          @endif
                          @if($ins['4e_10_smoke_detectors']=="fail" && $ins['4e_10_failure_choice']==2)
                              04.10 Stove or Range with Oven:
              ...
              $ins['5_4_other_potentially_hazardous_features_in_these_rooms']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['5_2_security']=="fail"  && $ins['5_2_failure_choice']==2)
                              05.02 Security:
                              {{$ins['5_2_Comment']}}<br>
                          @endif
                          @if($ins['5_3_electricity_hazards']=="fail"  && $ins['5_3_failure_choice']==2)
                              05.03 Electricity Hazards:
                              {{$ins['5_3_Comment']}}<br>
                          @endif
                          @if($ins['5_4_other_potentially_hazardous_features_in_these_rooms']=="fail"  && $ins['5_4_failure_choice']==2)
                              05.04 Security:
                              {{$ins['5_4_Comment']}}<br>
                          @endif
                      </td>
                 ...
                 ||$ins['6_6b_lead_based_paint']=="fail"||$ins['6_7_manufactured_home_tie_downs']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['6_1_condition_of_foundation']=="fail"  && $ins['6_1_failure_choice']==2)
                              06.01 Condition of Foundation:
                              {{$ins['6_1_Comment']}}<br>
                          @endif
                          @if($ins['6_2_condition_of_stairs_rails_and_porches']=="fail"  && $ins['6_2_failure_choice']==2)
                              06.02 Condition of Stairs, Rails, and Porches :
                              {{$ins['6_2_Comment']}}<br>
                          @endif
                          @if($ins['6_3_condition_of_roof_or_gutters']=="fail"  && $ins['6_3_failure_choice']==2)
                              06.03 Condition of Roof/Gutters :
                              {{$ins['6_3_Comment']}}<br>
                          @endif
                          @if($ins['6_4_condition_of_exterior_surface']=="fail"  && $ins['6_4_failure_choice']==2)
                              06.04 Condition of Exterior Surfaces :
                              {{$ins['6_4_Comment']}}<br>
                          @endif
                          @if($ins['6_5_condition_of_chimney']=="fail"  && $ins['6_5_failure_choice']==2)
                              06.05 Condition of Chimney:
                              {{$ins['6_5_Comment']}}<br>
                          @endif
                          @if($ins['6_6a_lead_based_paint']=="fail"  && $ins['6_6a_failure_choice']==2)
                              06.06.01 Lead Based Paint:
                              {{$ins['6_6a_Comment']}}<br>
                          @endif
                          @if($ins['6_6b_lead_based_paint']=="fail"  && $ins['6_6b_failure_choice']==2)
                              06.06.02 Lead Based Paint:
                              {{$ins['6_6b_Comment']}}<br>
                          @endif
                          @if($ins['6_7_manufactured_home_tie_downs']=="fail"  && $ins['6_7_failure_choice']==2)
                 ...
                 ||$ins['7_7_sewer_connection']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['7_1_adquacy_of_heating_equipment']=="fail"  && $ins['7_1_failure_choice']==2)
                              07.01 Adequacy of Heating Equipment:
                              {{$ins['7_1_Comment']}}<br>
                          @endif
                          @if($ins['7_2_safetyof_heating_equipment']=="fail"  && $ins['7_2_failure_choice']==2)
                              07.02 Safety of Heating Equipment:
                              {{$ins['7_2_Comment']}}<br>
                          @endif
                          @if($ins['7_3_ventilation_or_cooling']=="fail"  && $ins['7_3_failure_choice']==2)
                              07.03 Ventilation/Cooling:
                              {{$ins['7_3_Comment']}}<br>
                          @endif
                          @if($ins['7_4_water_heater']=="fail"  && $ins['7_4_failure_choice']==2)
                              07.04 Water Heater:
                              {{$ins['7_4_Comment']}}<br>
                          @endif
                          @if($ins['7_5_approvable_water_supply']=="fail"  && $ins['7_5_failure_choice']==2)
                              07.05 Approvable Water Supply:
                              {{$ins['7_5_Comment']}}<br>
                          @endif
                          @if($ins['7_6_plumbing']=="fail"  && $ins['7_6_failure_choice']==2)
                              07.06 Plumbing:
                              {{$ins['7_6_Comment']}}<br>
                          @endif
                          @if($ins['7_7_sewer_connection']=="fail"  && $ins['7_7_failure_choice']==2)
                 ...
                 $ins['8_11_lead_based_paint_owner_certification']=="fail")
                  <tr>
                      <td style="font-family: 'arial', sans-serif; font-size: 12px;  padding-top: 15px; padding-left: 35px; line-height: 15px; ">
                          ...
                          @if($ins['8_1_access_to_unit']=="fail"  && $ins['8_1_failure_choice']==2)
                              08.01 Access to Unit:
                              {{$ins['8_1_Comment']}}<br>
                          @endif
                          @if($ins['8_2_fire_exits']=="fail"  && $ins['8_2_failure_choice']==2)
                              08.02 Fire Exits:
                              {{$ins['8_2_Comment']}}<br>
                          @endif
                          @if($ins['8_3_evidence_of_infestation']=="fail"  && $ins['8_3_failure_choice']==2)
                              08.03 Evidence of Infestation:
                              {{$ins['8_3_Comment']}}<br>
                          @endif
                          @if($ins['8_4_garbage_and_debris']=="fail"  && $ins['8_4_failure_choice']==2)
                              08.04 Garbage and Debris :
                              {{$ins['8_4_Comment']}}<br>
                          @endif
                          @if($ins['8_5_refuse_disposal']=="fail"  && $ins['8_5_failure_choice']==2)
                              08.05 Refuse Disposal:
                              {{$ins['8_5_Comment']}}<br>
                          @endif
                          @if($ins['8_6_interior_stairs_and_common_halls']=="fail"  && $ins['8_6_failure_choice']==2)
                              08.06 Interior Stairs and Common Halls :
                              {{$ins['8_6_Comment']}}<br>
                          @endif
                          @if($ins['8_7_other_interior_hazards']=="fail"  && $ins['8_7_failure_choice']==2)
                              08.07 Other Interior Hazards :
                              {{$ins['8_7_Comment']}}<br>
                          @endif
                          @if($ins['8_8_elevators']=="fail"  && $ins['8_8_failure_choice']==2)
                              08.08 Elevators:
                              {{$ins['8_8_Comment']}}<br>
                          @endif
                          @if($ins['8_9_interior_air_quality']=="fail"  && $ins['8_9_failure_choice']==2)
                              08.09 Interior Air Quality:
                              {{$ins['8_9_Comment']}}<br>
                          @endif
                          @if($ins['8_10_site_and_neighborhood_conditions']=="fail"  && $ins['8_10_failure_choice']==2)
                              08.10 Site and Neighbourhood Conditions:
                              {{$ins['8_10_Comment']}}<br>
                          @endif
                          @if($ins['8_11_lead_based_paint_owner_certification']=="fail"  && $ins['8_11_failure_choice']==2)
            ...
            <tr>
              <td style="font-family: 'arial', sans-serif; font-size: 12;  padding-top: 15px; line-height: 15px; "> 
                <b>If the items are not completed within 24 hours (24 hours failures) and/or 30 days (returned within 20 days to allow for scheduling a reinspection) as identified above, 
