          ...
          <div class="box box-primary">
            ...
            <div style="padding: 20px 20px;">
                 @include('errors.error_notification')
                    @if(isset($artists))
                      {{ Form::model($artists, ['route' => ['artists.update', $artists->id], 'method'=>'PUT', 'class'=>'form-horizontal role','id'=>'artists_form']) }}
                   @else
                      {{ Form::open(['url'=>'admin/artists', 'method'=>'POST', 'class'=>'form-horizontal role','id'=>'artists_form']) }}
                  @endif
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! csrf_field() !!}
                           {{ Form::text('name', null, ['class' => 'form-control col-md-7 col-xs-12','placeholder'=>'Artist Name','id'=>'name']) }}
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 icheckbox_flat-green checked">
                          @if(isset($artists))
                            {{ Form::checkbox('active',1, ($artists->active === 1)?true:null, ['id'=>'active']) }}
                          @else
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="{{ url('/admin').'/artists'}}" class="btn btn-primary">Cancel</a>
